			...
			<div class="navigation">
				...
				<nav class="cl-effect-11" id="cl-effect-11">
							<ul class="nav1">
								...
								<li><a class="active" href="<?= base_url();?>/index.php/welcome/checkmoney" data-hover="MONEY">MONEY</a></li>
		...
		<h3 class="tittle">การชำระเงิน</h3>
			...
			<thead>
				...
				<div class='load'>";
							echo"
							<td><h4>
					<input type=\"button\" class=\"btn btn-danger\" onclick=\"location.href='<?= base_url();?>/index.php/welcome/cancel_money?id=$id';\" value=\"ยกเลิกการจอง\">
							</h4></td>
							</tr>
