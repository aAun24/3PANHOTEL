...
?>
		...
		while($row1=$result1->fetch_object()){	
            ...
            echo "<td><input type=\"text\" class=\"form-control\" name=\"price\" id=\"price\" value=\"$row1->price\"></td>";
           
            //echo "<td><input type=\"text\" class=\"form-control\" name=\"per\" value=\"".(($row1->per*'100')-100)."\" id=\"per\"></td>";
            echo "<td><input type=\"text\" class=\"form-control\" name=\"per\" value=\"$row1->percent\" id=\"per\"></td>";
