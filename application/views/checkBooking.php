			...
			<div class="navigation">
				...
				<nav class="cl-effect-11" id="cl-effect-11">
							<ul class="nav1">
								...
								<!-- -->
								<li><a href="<?= base_url();?>/index.php/welcome/Updategallery" data-hover="GALLERY">GALLERY</a></li>
								<li><a class="active" href="<?= base_url();?>/index.php/welcome/checkBooking" data-hover="BOOKING">BOOKING</a></li>
		...
		<h3 class="tittle">สถานะการเข้าพัก</h3>
			...
			<thead>
				...
				<div class='load'>";
							echo"
							<td><h4>
					<input type=\"button\" class=\"btn btn-success\" onclick=\"location.href='<?= base_url();?>/index.php/welcome/ok_book?id=$id';\" value=\"เข้าพัก\">
					<input type=\"button\" class=\"btn btn-danger\" onclick=\"location.href='<?= base_url();?>/index.php/welcome/cancel_book?id=$id';\" value=\"ไม่เข้าพัก\">
							</h4></td>
							</tr>
...
<script type="text/javascript">
	 ...
	 //        }
	 //       xmlhttp1.open("post","<?= base_url();?>/index.php/welcome/form_updatebook"+id_book,true);
	 //       xmlhttp1.send();
	    }
		...
		if(window.XMLHttpRequest){
	       ...
	       xmlhttp1.open("post","<?= base_url();?>/index.php/welcome/form_deletebook",true);
	       xmlhttp1.send();
	    }
