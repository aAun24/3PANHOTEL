			...
			<div class="navigation">
				...
				<nav class="cl-effect-11" id="cl-effect-11">
							<ul class="nav1">
								...
								<li><a class="active" href="http://angsila.cs.buu.ac.th/~57160284/887240/Project/index.php/welcome/checkBooking" data-hover="BOOKING">BOOKING</a></li>
...
<div class="contact">
	<div class="container">
		<h3 class="tittle">สถานะการเข้าพัก</h3>
			<table class="table">
			<thead>
				<tr>
				...
				$sql2 = "SELECT * FROM Book_Hotel where status = 'ชำระเงินแล้ว' order by id_book desc";
				...
				<div class='load'>";
							echo"
							<td><h4>
					<input type=\"button\" class=\"btn btn-success\" onclick=\"location.href='http://angsila.cs.buu.ac.th/~57160284/887240/Project/index.php/welcome/ok_book?id=$id';\" value=\"เข้าพัก\">
					<input type=\"button\" class=\"btn btn-danger\" onclick=\"location.href='http://angsila.cs.buu.ac.th/~57160284/887240/Project/index.php/welcome/cancel_book?id=$id';\" value=\"ไม่เข้าพัก\">
							</h4></td>
							</tr>
...
<script type="text/javascript">
	 ...
	 //        	document.getElementById("load5").innerHTML = xmlhttp1.responseText;
	 //        }
	 //       xmlhttp1.open("post","http://angsila.cs.buu.ac.th/~57160284/887240/Project/index.php/welcome/form_updatebook"+id_book,true);
	 //       xmlhttp1.send();
	    }
		...
		if(window.XMLHttpRequest){
	       ...
	       xmlhttp1.open("post","http://angsila.cs.buu.ac.th/~57160284/887240/Project/index.php/welcome/form_deletebook",true);
	       xmlhttp1.send();
	    }
