...
<head>
				...
				<div class="header-nav">
					...
					<div class="navigation">
						...
						<nav class="cl-effect-11" id="cl-effect-11">
							<ul class="nav1">
								<li><a  href="<?= base_url();?>/index.php/welcome/sell1" data-hover="SELL">SELL</a></li>
								<!--<li><a href="<?= base_url();?>/index.php/welcome/form_searchRoom" data-hover="BOOKING">BOOKING</a></li>-->
								<li><a class="active" href="<?= base_url();?>/index.php/welcome/account" data-hover="ACCOUNT">ACCOUNT</a></li>
  ...
  <script type="text/javascript">
		...
		if(window.XMLHttpRequest){
	       ...
	       xmlhttp1.open("post","<?= base_url();?>/index.php/welcome/detailaccount",true);
