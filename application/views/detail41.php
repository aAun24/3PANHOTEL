					...
					<div class="navigation">
						...
						<nav class="cl-effect-11" id="cl-effect-11">
							<ul class="nav1">
								...
								<li><a class="active" href="<?= base_url();?>/index.php/welcome/detail41" data-hover="ROOM">ROOM</a></li><li><a href="<?= base_url();?>/index.php/welcome/about" data-hover="ABOUT">ABOUT</a></li>
			...
			<div class="container">
				<div class="col-md-8 single-gd-lt">
					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?= base_url();?>/dist/images/family.jpg">
								<img src="<?= base_url();?>/dist/images/family.jpg" alt=""/ >
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family2.jpg">
								<img src="<?= base_url();?>/dist/images/family2.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family5.jpg">
								<img src="<?= base_url();?>/dist/images/family5.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family6.jpg">
								<img src="<?= base_url();?>/dist/images/family6.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family7.jpg">
								<img src="<?= base_url();?>/dist/images/family7.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family8.jpg">
								<img src="<?= base_url();?>/dist/images/family8.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family9.jpg">
								<img src="<?= base_url();?>/dist/images/family9.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family4.jpg">
								<img src="<?= base_url();?>/dist/images/family4.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/family3.jpg">
								<img src="<?= base_url();?>/dist/images/family3.jpg" alt=""/>
							</li>
						</ul>
					</div>
					<!-- FlexSlider -->
		...
		<div class="footer">
			<div class="container">				 	
				<div class="col-md-4 ftr_navi ftr">
					...
					<ul>
						<li><a href="<?= base_url();?>" data-hover="HOME">HOME</a></li>
						<li><a href="<?= base_url();?>/index.php/welcome/detail41" data-hover="ROOM">ROOM</a></li>
