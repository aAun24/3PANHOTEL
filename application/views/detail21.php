					...
					<div class="navigation">
						...
						<nav class="cl-effect-11" id="cl-effect-11">
							<ul class="nav1">
								...
								<li><a class="active" href="<?= base_url();?>/index.php/welcome/detail21" data-hover="ROOM">ROOM</a></li>
			...
			<div class="container">
				<div class="col-md-8 single-gd-lt">
					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?= base_url();?>/dist/images/su2.jpg">
								<img src="<?= base_url();?>/dist/images/su2.jpg" alt=""/ >
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su1.jpg">
								<img src="<?= base_url();?>/dist/images/su1.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su3.jpg">
								<img src="<?= base_url();?>/dist/images/su3.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su4.jpg">
								<img src="<?= base_url();?>/dist/images/su4.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su5.jpg">
								<img src="<?= base_url();?>/dist/images/su5.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su6.jpg">
								<img src="<?= base_url();?>/dist/images/su6.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su7.jpg">
								<img src="<?= base_url();?>/dist/images/su7.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su8.jpg">
								<img src="<?= base_url();?>/dist/images/su8.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su9.jpg">
								<img src="<?= base_url();?>/dist/images/su9.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/su10.jpg">
								<img src="<?= base_url();?>/dist/images/su10.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/Deluxe1.jpg">
								<img src="<?= base_url();?>/dist/images/Deluxe1.jpg" alt=""/ >
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/Deluxe2.jpg">
								<img src="<?= base_url();?>/dist/images/Deluxe2.jpg" alt=""/ >
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/Deluxe3.jpg">
								<img src="<?= base_url();?>/dist/images/Deluxe3.jpg" alt=""/ >
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/Deluxe4.jpg">
								<img src="<?= base_url();?>/dist/images/Deluxe4.jpg" alt=""/ >
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/Deluxe5.jpg">
								<img src="<?= base_url();?>/dist/images/Deluxe5.jpg" alt=""/ >
							</li>
		...
		<div class="footer">
			<div class="container">				 	
				<div class="col-md-4 ftr_navi ftr">
					...
					<ul>
						<li><a href="<?= base_url();?>" data-hover="HOME">HOME</a></li>
						<li><a href="<?= base_url();?>/index.php/welcome/detail21" data-hover="ROOM">ROOM</a></li>
						<li><a href="<?= base_url();?>/index.php/welcome/about" data-hover="ABOUT">ABOUT</a></li>
						<li><a href="<?= base_url();?>/index.php/welcome/contact" data-hover="CONTACT">CONTACT</a></li>
					</ul>
				</div>
