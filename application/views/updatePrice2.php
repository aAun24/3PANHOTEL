...
?>
    	...
    	while($row2=$result2->fetch_object()){ 
            ...
            echo "<td><input type=\"text\" class=\"form-control\" name=\"price\" id=\"price\" value=\"$row2->price\"></td>";
           
            //echo "<td><input type=\"text\" class=\"form-control\" name=\"per\" value=\"".(($row1->per*'100')-100)."\" id=\"per\"></td>";
            echo "<td><input type=\"text\" class=\"form-control\" name=\"per\" value=\"$row2->percent\" id=\"per\"></td>";
