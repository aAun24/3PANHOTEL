...
?>
        ...
        while($row4=$result4->fetch_object()){ 
            ...
            echo "<input type='hidden' name='name' value='$row4->name'>";
            echo "<td><input type=\"text\" class=\"form-control\" name=\"price\" id=\"price\" value=\"$row4->price\"></td>";
           
            //echo "<td><input type=\"text\" class=\"form-control\" name=\"per\" value=\"".(($row1->per*'100')-100)."\" id=\"per\"></td>";
            echo "<td><input type=\"text\" class=\"form-control\" name=\"per\" value=\"$row4->percent\" id=\"per\"></td>";
              echo "<td><button type='submit' class='btn btn-success' onclick='update4()'>Update</button></td>";      
            echo "</tr>"; 
