					...
					<div class="navigation">
						...
						<nav class="cl-effect-11" id="cl-effect-11">
							<ul class="nav1">
								...
								<li><a class="active" href="<?= base_url();?>/index.php/welcome/detail31" data-hover="ROOM">ROOM</a></li><li><a href="<?= base_url();?>/index.php/welcome/about" data-hover="ABOUT">ABOUT</a></li>
			...
			<div class="container">
				<div class="col-md-8 single-gd-lt">
					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?= base_url();?>/dist/images/suite.jpg">
								<img src="<?= base_url();?>/dist/images/suite.jpg" alt=""/ >
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/suite2.jpg">
								<img src="<?= base_url();?>/dist/images/suite2.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/suite3.jpg">
								<img src="<?= base_url();?>/dist/images/suite3.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/suite4.jpg">
								<img src="<?= base_url();?>/dist/images/suite4.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/suite5.jpg">
								<img src="<?= base_url();?>/dist/images/suite5.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/suite6.jpg">
								<img src="<?= base_url();?>/dist/images/suite6.jpg" alt=""/>
							</li>
							<li data-thumb="<?= base_url();?>/dist/images/suite7.jpg">
								<img src="<?= base_url();?>/dist/images/suite7.jpg" alt=""/>
							</li>
		...
		<div class="footer">
			<div class="container">				 	
				<div class="col-md-4 ftr_navi ftr">
					...
					<ul>
						<li><a href="<?= base_url();?>" data-hover="HOME">HOME</a></li>
						<li><a href="<?= base_url();?>/index.php/welcome/detail31" data-hover="ROOM">ROOM</a></li>
